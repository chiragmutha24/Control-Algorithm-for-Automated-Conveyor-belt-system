...
def reverse(delay = 0.001):
    ...
    while run_state:
        ...
        if dist>72:
            ...
            print('Speed set to ' + str(delay))
            print("Motor started")
        elif dist>= 68 and dist <=72 and GPIO.input(ir_sensor) == 0:
            GPIO.output(ENA, GPIO.LOW) # This is actualy a delay between PUL pulses - effectively sets the mtor rotation speed.
            time.sleep(2)
            print('Speed set to ' + str(delay))
            val = int(hx.get_weight(5))
            print(f"The weight is {val} gms")
            GPIO.output(ENA, GPIO.HIGH)
            if val>=95 and val<=150:
                delay = 0.00001 # This is actualy a delay between PUL pulses - effectively sets the mtor rotation speed.
                print('Speed set to ' + str(delay))
            elif val>= 195 and val<= 250:
                delay = 0.00001 # This is actualy a delay between PUL pulses - effectively sets the mtor rotation speed.
                print('Speed set to ' + str(delay))
            elif val>= 295 and val<= 350:
                delay = 0.000001 # This is actualy a delay between PUL pulses - effectively sets the mtor rotation speed.
                print('Speed set to ' + str(delay))
            elif val>= 495 and val<= 550:
                delay = 0.00001 # This is actualy a delay between PUL pulses - effectively sets the mtor rotation speed.
                print('Speed set to ' + str(delay))
            elif val>= 695 and val<= 750:
                delay = 0.0001 # This is actualy a delay between PUL pulses - effectively sets the mtor rotation speed.
                print('Speed set to ' + str(delay))
            elif val>= 995 and val<= 1050:
                delay = 0.001 # This is actualy a delay between PUL pulses - effectively sets the mtor rotation speed.
                print('Speed set to ' + str(delay))
        if dist<22:
            GPIO.output(ENA, GPIO.LOW)
